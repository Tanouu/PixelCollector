...
INSERT INTO `users` (`2fa_enabled`, `birth_date`, `id`, `email`, `password`, `photo`, `username`, `wallet_address`) VALUES
	(b'0', '2002-12-17', 1, 'ethanpacheco.t@gmail.com', '$2a$10$P9xNS7GJSohjHGWe3uOw.OtEiBiZvdBPQ8NZDchoCTLUAwS.u9mka', 'oui', 'Tanouu', '0fgfdfgdghggjkghkhkhhb'),
	(b'1', '2002-12-17', 2, 'p.tanou@outlook.fr', '$2a$10$VSyg4gtb4xKYfuhx0swZIOlIRf4FOVRAsGFH5Pe11m8uv7za1vHXK', 'oui', 'Tanou', '0fgfdfgdgf');
